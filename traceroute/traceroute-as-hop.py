...
*) Input:
Text files containing the traceroute AS hops (ASN) separated by a blank space. These files are created by processing
JSON files from RIPE Atlas measurements.
