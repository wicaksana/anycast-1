...
* Output:
Individual files per probe in the traceroute measurement, stored in directory 'traceroute_probe'. These files contain
in each line all the hops in a traceroute run.
"""
